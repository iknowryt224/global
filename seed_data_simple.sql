-- Global Access Shipping - Simplified Seed Data
-- Use this file if you don't want to manually create users first
-- This only seeds locations and shipments (avoiding FK constraint issues)

-- ============================================
-- STEP 1: Get actual UUIDs from your auth.users
-- ============================================
-- Run this query first in Supabase SQL Editor:
-- SELECT id, email FROM auth.users;
-- Copy the UUIDs and replace the values below

-- Placeholder UUIDs - REPLACE FROM YOUR AUTH.USERS VALUES ABOVE
-- Example: If your admin user has UUID 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', use that
...
VALUES 
    ...
    (
        ...
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid  -- REPLACE WITH YOUR ADMIN UUID
    ),
    (
...
-- ============================================
-- IMPORTANT: Replace the UUIDs below with actual values from your auth.users table:
-- created_by: Use your admin UUID
-- assigned_driver_id: Use your driver UUID
...
VALUES 
    ...
    (
        ...
        'in_transit',
        'a1b2c3d4-e5f6-7890-abcd-ef1234567890'::uuid,  -- REPLACE WITH YOUR ADMIN UUID
        'b2c3d4e5-f6a7-1890-bcde-f12345678901'::uuid,  -- REPLACE WITH YOUR DRIVER UUID
        NOW() + INTERVAL '2 days'
    ),
...
-- ============================================
-- IMPORTANT: Replace driver UUID below with actual value from your auth.users table
